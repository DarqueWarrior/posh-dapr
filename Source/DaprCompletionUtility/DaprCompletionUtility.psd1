@{
   ...
   RootModule        = 'DaprCompletionUtility'
   ...
   GUID              = 'cb52d605-779b-4df5-8b72-3eb9debb2c21'
   ...
   Description       = 'Utility for DaprCompletion.'
   ...
   FunctionsToExport = @('_callDapr', 'Get-Releases', 'Get-Instances')
