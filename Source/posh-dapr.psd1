...
#
# .ExternalHelp posh-dapr-Help.xml
...
@{
   ...
   ModuleVersion        = '1.0.0-rc.3'

   # Supported PSEditions
   CompatiblePSEditions = @('Core', 'Desktop')

   # ID used to uniquely identify this module
   GUID                 = 'c8d2567f-467e-4847-b73d-ea9b38128b39'
   ...
   PrivateData          = @{
      ...
      PSData = @{
         ...
         Tags         = @('dapr', 'k8s', 'heml', 'kubclt', 'Kubernetes', 'Docker', 'Microservices')
         ...
         LicenseUri   = 'https://github.com/DarqueWarrior/posh-dapr/blob/trunk/LICENSE'

         # A URL to the main website for this project.
         ProjectUri   = 'https://github.com/DarqueWarrior/posh-dapr'

         # A URL to an icon representing this module.
         # IconUri = ''

         # ReleaseNotes of this module
         ReleaseNotes = 'https://github.com/DarqueWarrior/posh-dapr/vsteam/blob/trunk/CHANGELOG.md'
